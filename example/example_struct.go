...
//go:generate accessors -d -k public,private methods getters,setters ExampleStruct
//go:generate accessors -d -o iface/example_iface.go interface --name=Example --pkg=iface getters,setters ExampleStruct Scalar Ptr
